...
<div class="container">
    <header class="c-header-box">
        ...
        <h2 class="title">Globin<br> Light php framework for swoole engine</h2>
        <p class="description">Learn from <strong>Yii2 framework!</strong></p>
        <div class="guide">
            <div class="installation-a">
                Install Goblin
            </div>
            <div class="installation-b">composer require toom1996/yiis</div>
        </div>
        <div class="css-1bkpu5b">
            <a href="https://github.com/popperjs/popper-core" rel="nofollow noreferrer" class="guide-button">
