...
<style>
  ...
  @version 1.1.0
*/.hljs{background:#fff;color:#000}.language-xml .meta,.language-xml .meta-string{font-weight:700;font-style:italic;color:#48b}.comment,.quote{font-style:italic;color:#070}.built_in,.keyword,.name{color:#808}.attr,.name{font-weight:700}.string{font-weight:400}.code,.link,.meta .string,.number,.regexp,.string{color:#00f}.bullet,.symbol,.template-variable,.title,.variable{color:#f40}.class .title,.title.class_,.type{font-weight:700;color:#639}.attr,.function .title,.subst,.tag,.title.function_{color:#000}.formula{background-color:#eee;font-style:italic}.addition{background-color:#beb}.deletion{background-color:#fbb}.meta{color:#269}.section,.selector-class,.selector-id,.selector-pseudo,.selector-tag{font-weight:700;color:#48b}.selector-pseudo{font-style:italic}.doctag,.strong{font-weight:700}.emphasis{font-style:italic}
